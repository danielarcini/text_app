...
function init() {
  ...
  addRoom("lobby2");
  changeRoom("lobby");
  addMessage("lobby", "Live Chat", "Hey! Have someone open another browser with the same url so you can Message eachother in RealTime.", true);
  addMessage("lobby2", "Live Chat", "WOW, another room.", true);
  ...
  newRoomForm.addEventListener("submit", (e) => {
    ...
    addMessage(room, "Live Chat", `Would you take a look at that, its your own "${room}" room!`, true);
  })
